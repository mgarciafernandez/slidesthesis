...
\vspace*{1cm}
Dark Energy: Responsible for the acceleration.\\
\vspace*{1cm}
...
$\rightarrow$ Disagreement between Cosmology and HEP:\\
...
\vspace{0.2cm}
\begin{itemize}
\item S/G-separation: {\tt modest\_class} (morphological classifier).
\vspace{0.2cm}
...
\vspace{0.2cm}
\begin{center}
\includegraphics[width=0.7\textwidth,trim={0 15cm 0 0},clip]{./magdist_balrog.png}
\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
$\rightarrow$ Covariances reduce the impact of the measurement.
\vspace{0.2cm}
...
{\bf Theory:}\\
\vspace{0.2cm}
$\rightarrow$ Used Fiedrich et al. (1710.05162) and Gruen et al. (1710.05045) theory.\\
\vspace{0.2cm}
...
\vspace{0.3cm}
\item Lowest void scales provide constraints on Modified Gravity scenarios.
\vspace{0.3cm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\begin{small}\underline{{\bf Accomplishments.}}\end{small}}
\begin{itemize}
\item Member of DES and PAU-Survey Collaborations.
\vspace{0.3cm}
\item Leader of magnification analysis on DES.
\vspace{0.3cm}
\item First author of one paper and a proceeding.
\vspace{0.3cm}
\item Five talks at international conferences.
\vspace{0.3cm}
\item Observer for DES at Cerro Tololo and for PAU-Survey at La Palma.
\vspace{0.3cm}
\item Outreach talks at public schools.
\vspace{0.3cm}
\item Intership at Jet Propulsion Laboratory (NASA/Caltech).
\vspace{0.3cm}
\item Responsible for running {\scshape Balrog} at DES-Y1.
\vspace{0.3cm}
\item Optimized {\scshape Balrog} software stack at the Grid.
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\frametitle{\begin{small}\underline{{\bf Non-published work.}}\end{small}}
\begin{itemize}
\item Measured the galaxy-bias of DES-SV with magnification.
\vspace{0.3cm}
\item Explored the possible measurement of a non-linear bias with DES-SV
\vspace{0.3cm}
\item Developed the flux-magnification measurement with DES-SV
\vspace{0.3cm}
\item Explored the possible combination of number-count, flux and size magnification.
\vspace{0.3cm}
\item Explored a methodology to use full depth of the survey.
\vspace{0.3cm}
\item Explored the possible use of cross-correlations to estimate photo-z contamination.
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}
